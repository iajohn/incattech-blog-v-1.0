			        ...
			        <div class="row">
			          	<div class="col-md-12">        
				            ...
				            <div class="section-title">
		                        <h2 class="title page-title">{{ __('Category') }} | {{ $category->name }}</h2>
		                    </div>
			        	...
			        	@if($posts->count() > 0)
						             	...
						             	<figure class="article-img">
						              	...
						              	<div class="details">
							                <div class="detail">
							                  	...
							                  	<div class="category"> Posted By <a href="#">{{ $post->user->name }}</a></div>
	                        ...
	                        <div class="">
	                            <div class="alert alert-info text-center">
	                                {{ __('Sorry, there are no posts in this category check later!') }}
	                            </div>                   
	                        </div>
	                    @endif
