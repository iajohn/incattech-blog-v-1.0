...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('video.store') }}" method="post" data-toogle="validator" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        <div class="custom-file">
                            <input type="file" name="featured" id="video" class="custom-file-input" >
