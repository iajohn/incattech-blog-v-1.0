    ...
    <div class="card">
        <div class="mt-3 mb-0 ml-3">
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <a href="{{ route('video.create') }}" class="btn btn-sm btn-primary">{{ __('Add Post') }}</a>
                    <!-- <a onclick="addNewPost()" class="btn btn-sm btn-primary">{{ __('Add Post') }}</a> -->
                    <a href="{{ route('videos.trashed') }}" class="btn btn-sm btn-danger">Trashed</a>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            ...
                            There are no uploaded videos at the moment!
                            </th>                   
                        </tr>
